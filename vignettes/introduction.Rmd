---
title: "Introduction to qss.student"
author: "Will Lowe"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to qss.student}
...
The `qss.student` package contains all the problem sets from   

> K. Imai (2016) 'Quantitative Social Science: An Introduction', Princeton
> University Press 

plus a few extras not in the book.
...
two together into a document.  What *kind* of a document is controllable from that 
button.  If you chose 'Knit to HTML' (the default) your document will be called 
'bias-in-turnout.html'.  If you chose 'Knit to PDF' or 'Knit to Word' it will 
